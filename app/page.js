  ...
  return (
    <>
      ...
      <div className="bg-[#5b0017] h-fit  pt-20 text-white">
        <div className="absolute top-18 z-10 w-full h-10 bg-black/60 py-2 px-4 shadow-xl shadow-black/40">
          {" "}
          <span className="font-semibold">
            ITS WILL LIVE AFTER DURGA PUJA !
          </span>
        </div>
        <div>
          <Image
        ...
        <div className="bg-black/40 relative z-2 h-90 md:h-100 md:mx-60 my-8 mx-6 p-6 shadow-md shadow-amber-300/50  rounded-xl flex flex-col items-center justify-between gap-2 md:gap-6 pb-2">
          <span className="font-bold text-2xl">Shankar&apos;s Restraunt</span>
          <div className="h-full w-full flex justify-around">
            <div className="h-full  w-40 flex flex-col items-center gap-2">
              <span className="font-bold text-xl border-b-2">2004</span>
              <span className="text-sm font-light">Hailing from Odisha,</span>
              <span className="text-sm font-light">
                we began our journey with a humble sweet shop,
              </span>
              <span className="text-sm font-light">
                earning love and trust for authentic flavors.
              </span>
            </div>
            <div className="h-full  w-40 flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-light">
                we expanded to open Shankar&apos;s Restaurant,
              </span>
              <span className="text-sm font-light">
                serving a wider variety of delicious dishes.
              </span>
              <span className="text-sm font-light">
                Now offering a perfect blend of Sweet & Spicy delights.
              </span>
            </div>
            {/* <div className="h-full  w-20 flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-light">
                we continue our mission to serve joy on every plate.
              </span>
            </div> */}
          </div>
        </div>
